...
INSERT INTO MOVIE VALUES(MOVIE_SEQ.NEXTVAL, '과속스캔들', '코미디', '스무두살 딸 여섯살 손자', 3);
INSERT INTO MOVIE VALUES(MOVIE_SEQ.NEXTVAL, '엽기적인 그녀', '코미디', '건우야 미안해', 4);
COMMIT;