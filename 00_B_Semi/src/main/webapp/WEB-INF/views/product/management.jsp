                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between" width=800px;>
...
<script src="${contextPath}/resources/js/sb-admin-2.min.js"></script>
    ...
    <script src="${contextPath}/demo/chart-area-demo.js"></script>
    <script src="${contextPath}/demo/chart-pie-demo.js"></script>
