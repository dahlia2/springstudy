...
<script>
	...
	function fn1(){
		$.ajax({
			// 요청
			type: 'post',                     // 서버로 보낼 데이터를 요청 본문(request body)에 저장해서 보낸다. (주소창 확인 x)
			...
			// 응답
			dataType: 'json',
			success: function(resData){       // resData = {"name": "이현주", "tel": "010-1234-1234"}
				let str = '<ul>';
				str += '<li>' + resData.name;
				str += '<li>' + resData.tel;   // <ul>와 <li> 닫는 태그 생략 가능
				$('#result').html(str);   	   // 기존 내용 덮어쓰기 (append은 덧붙이기)
			},
