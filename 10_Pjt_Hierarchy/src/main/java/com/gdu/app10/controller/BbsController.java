...
public class BbsController {
	...
	public String add(HttpServletRequest request, RedirectAttributes redirectAttributes) {
		redirectAttributes.addFlashAttribute("addResult", bbsService.addBbs(request, redirectAttributes));
		return "redirect:/bbs/list.do";
	}
	
	@PostMapping("/remove.do")
	public String remove(int bbsNo, RedirectAttributes redirectAttributes){  // @RequestParam 생략
		redirectAttributes.addFlashAttribute("removeResult", bbsService.removeBbs(bbsNo));
		return "redirect:/bbs/list.do";
	}
