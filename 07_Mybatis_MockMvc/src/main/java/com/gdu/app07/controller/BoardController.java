...
public class BoardController {
	...
	*/
	...
	// jsp에서 파라미터로 요청한 게 아니니까 HttpServletRequest을 사용할 필요 없다. forward할 정보는 Model이 저장한다.
	// 반환타입이 jsp 파일명 (문자열)이니까 메소드 타입은 String
	...
	*/
	...
	public String modify(HttpServletRequest request, RedirectAttributes redirectAttributes) {
		...
		// 만약 수정하고 -> detail로 바로 가면 파라미터 값은 전달되지 않으므로 .do까지만 쓰면 안 됨.
	}   
