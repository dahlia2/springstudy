...
<script>
	...
	function fnRemove() {
		if(confirm('삭제할까요?')) {
			location.href= '${contextPath}/board/remove.do?board_no=${b.board_no}';  /* 이렇게 쓰면 외부인도 주소창으로 접근이 가능 */	
		}
	}
	...
	$(function(){    /* onload이벤트를 위해 script에 몰빵 */
		$('#content').summernote({    /* summernote 적용 스크립트 */
			width: 640,
			height: 480,
			lang: 'ko-KR',
			toolbar: [
